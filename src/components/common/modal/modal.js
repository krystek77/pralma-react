      ...
      <div className={styles.modal}>
        ...
        <div className={styles.modal__content}>
          ...
          <div className={styles.modal__clause}>
            ...
            <UnorderedList>
              <ListItem
                text="Administratorem Pani/Pana danych osobowych jest: Przedsiębiorstwo Produkcji Urządzeń Pralniczych “Pralma” Sp. z o.o. ul. Górnicza 49a, 25-651 Kielce NIP 6570081116, KRS 0000022564, tel. 41/3457408, 41/3450561, biuro@pralma.pl."
              />
              <ListItem
                text="Administrator nie wyznaczył Inspektora Ochrony Danych Osobowych."
              />
              <ListItem
                text="Ma Pani/Pan prawo dostępu do swoich danych, otrzymania ich kopii, ich sprostowania, usunięcia, ograniczenia przetwarzania, oraz prawo do przenoszenia danych, a także wniesienia sprzeciwu."
              />
              <ListItem
                text="Do Pani/Pana danych mogą mieć dostęp podmioty przetwarzające (działające na nasze zlecenie), takie jak: firmy księgowe, kancelarie prawnicze, firmy kurierskie, podmioty świadczące usługi płatności elektronicznych, administrator systemu sprzedażowego, dostawcy usług IT. Podanie danych jest dobrowolne, ale niezbędne do realizacji powyższych celów, w szczególności obowiązków prawnych Spółki, w tym realizacji Państwa zgłoszeń lub spraw (bez ich podania nasza Spółka nie będzie mogła realizować swych obowiązków, w tym Państwa zgłoszenia)"
              />
              <ListItem text="Dane przechowywane są bezterminowo." />
              <ListItem
                text="Przysługuje Pani/Panu wniesienia skargi do organu nadzorczego (Prezesa Urzędu Ochrony Danych Osobowych), jeśli Pani/Pana zdaniem przetwarzanie danych osobowych Pani/Pana narusza przepisy rozporządzenia RODO."
              />
              <ListItem
        ...
        <div className={styles.modal__actions}>
          ...
          <Button type="button" label="akceptuj" />
        </div>
      </div>
    </div>
  );
